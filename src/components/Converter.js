...
export default class Converter extends Component {
    ...
    render () {
        const {wrapper, inputStyle, textStyle, submitButton, submitButtonText, clearButton,Euro,Dolar,Tl} = styles;
        ...
        return (
            <View style={wrapper}>
                <View style={{flexDirection: 'row'}}>
                    {/* INPUT */}
                    <TextInput
                        placeholder={'Euro Değerini Giriniz:'}
                        style={inputStyle}
                    ...
                    >
                        <Text style={submitButtonText}>Hesapla</Text>
                    </TouchableOpacity> 
            ...
            <Text style={textStyle}>CUP : { cup }</Text>
				 ...
				 {/* Euro Hesapla Butonu */}
                    <TouchableOpacity 
                        ...
                        onPress={this.calculateCurrency}
                    >
                        <Text style={inputStyle} >Euro Seçimi Hesapla Butonu</Text>
                    </TouchableOpacity> 
					
					
					 {/* dolar Hesapla Butonu */}
                    <TouchableOpacity 
                        style={Dolar} 
                        activeOpacity={0.7}
                        onPress={this.calculateCurrency}
                    >
                        <Text style={inputStyle} >Dolar Seçimi Hesapla Butonu</Text>
                    </TouchableOpacity> 
                    ...
                    <TouchableOpacity 
                        ...
                        onPress={this.calculateCurrency}
                    >
                        <Text style={inputStyle} >TL Seçimi Hesapla Butonu</Text>
                    </TouchableOpacity> 
            </View>
        )
    }
